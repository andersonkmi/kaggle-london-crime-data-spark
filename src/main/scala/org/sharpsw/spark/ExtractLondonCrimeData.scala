...
object ExtractLondonCrimeData {
  ...
  def main(args: Array[String]): Unit = {
    ...
    if(args.nonEmpty) {
      ...
      timed("Exporting boroughs to csv", saveDataFrameToCsv(boroughs, 1, buildFilePath(destinationFolder, "borough_csv")))
      ...
      timed("Exporting lsoa codes to csv", saveDataFrameToCsv(lsoa, 1, buildFilePath(destinationFolder, "lsoa_csv")))
      ...
      timed("Exporting major categories to csv", saveDataFrameToCsv(majorCrimeCategories, 1, buildFilePath(destinationFolder, "major_category_csv")))
      ...
      timed("Exporting minor category to csv", saveDataFrameToCsv(minorCrimeCategories, 1, buildFilePath(destinationFolder, "minor_category_csv")))
      ...
      timed("Exporting categories to csv", saveDataFrameToCsv(categories, 1, buildFilePath(destinationFolder, "categories_csv")))
      ...
      timed("Exporting resulting aggregation to CSV", saveDataFrameToCsv(crimesByBorough, 1, buildFilePath(destinationFolder, "total_crimes_by_borough_csv")))
      ...
      timed("Exporting resulting aggregation - by major category to csv", saveDataFrameToCsv(crimesByMajorCategory, 1, buildFilePath(destinationFolder, "total_crimes_by_major_category_csv")))
      ...
      timed("Exporting resulting aggregation - by minor category to csv", saveDataFrameToCsv(crimesByMinorCategory, 1, buildFilePath(destinationFolder, "total_crimes_by_minor_category_csv")))
      ...
      timed("Exporting resulting aggregation - by borough and year to csv", saveDataFrameToCsv(crimesByBoroughAndYear, 1, buildFilePath(destinationFolder, "total_crimes_by_borough_year_csv")))
      ...
      timed("Exporting resulting aggregation - by major category and year to csv", saveDataFrameToCsv(crimesByMajorCategoryAndYear, 1, buildFilePath(destinationFolder, "total_crimes_by_major_category_year_csv")))
      ...
      timed("Exporting resulting aggregation - by minor category and year to csv", saveDataFrameToCsv(crimesByMinorCategoryAndYear, 1, buildFilePath(destinationFolder, "total_crimes_by_minor_category_year_csv")))
      ...
      timed("Exporting crimes by year results to csv", saveDataFrameToCsv(crimesByYear, 1, buildFilePath(destinationFolder, "total_crimes_by_year_csv")))
      ...
      timed("Exporting crimes by year and month results to CSV", saveDataFrameToCsv(crimesByYearMonth, 1, buildFilePath(destinationFolder, "total_crimes_by_year_month_csv")))
      ...
      crimePercentageByYear.foreach(item => {
        ...
        timed(s"Exporting crime percentage in ${item._1} to CSV", saveDataFrameToCsv(item._2, 1, buildFilePath(destinationFolder, s"crime_percentage_${item._1}_csv")))
      ...
      timed("Exporting results to csv", saveDataFrameToCsv(totalCrimesByYearAndLsoa, 1, buildFilePath(destinationFolder, "total_crimes_by_year_lsoa_code_csv")))
      timed("Exporting results to parquet", saveDataFrameToCsv(totalCrimesByYearAndLsoa, 1, buildFilePath(destinationFolder, "total_crimes_by_year_lsoa_code_parquet")))
      println(timing)
